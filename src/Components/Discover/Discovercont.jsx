        ...
        >
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <iframe
                height="600px"
                src="https://www.youtube.com/embed/_o3oHHTC5Uo?start=109"
      ...
      >
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <iframe
              height="600"
              src="https://www.youtube.com/embed/OT7HCb-MTuo"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
      ...
      >
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <iframe
              height="600"
              src="https://www.youtube.com/embed/1SOv8Q_Kfis"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
      ...
      >
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <iframe
              height="600"
              src="https://www.youtube.com/embed/fMSzNHUbLx0"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
      ...
      >
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <iframe
              height="600"
              src="https://www.youtube.com/embed/oO5__Kkj740"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
      ...
      >
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <iframe
              height="600"
              src="https://www.youtube.com/embed/zu8gBMLtcvM"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
          ...
          >
            <div className="figure hover-blur">
              ...
              <figcaption className="fig-caption no-bg text-white text-center">
                <h4>@Agra</h4>
                <p>
                  The most famous tourist place to visit in North India, Agra is
                  widely explored by tourists from all over the world. Its
                  special attraction Taj Mahal is a symbol of eternal love which
                  makes the city remain thong by the tourists having every kind.
                  Along with Taj Mahal, Agra Fort, Tomb of Itimad-ud-Daulah, and
                  Fatehpur Sikri are other places of attraction in the city
                </p>
              </figcaption>
            </div>
          </a>
            ...
            <div className="figure hover-blur">
              ...
              <figcaption className="fig-caption no-bg text-white text-center">
                ...
                <p>
                  ...
                  rich hospitality and cultural heritage. The city beholds a tag
                  of India’s famous UNESCO World Heritage Site which is surely
                  an amazing crowd puller located in India.{" "}
                </p>
              </figcaption>
            </div>
          </a>
            ...
            <div className="figure hover-blur">
              ...
              <figcaption className="fig-caption no-bg text-white text-center">
                ...
                <p>
                  ...
                  Nature has bestowed all her love. Enclosed by the Himalayas
                  and Karakoram ranges; and festooned with verdant meadows, lush
                  valleys, dense forests, splendid temples, this new union
                  territory of India is a holiday destination to instantly fall
                  in love with.
                </p>
              </figcaption>
            </div>
            ...
            <div className="figure hover-blur">
              ...
              <figcaption className="fig-caption no-bg text-white text-center">
                ...
                <p>
                  ...
                  heritage that is vital to the local identity and continuity of
                  the place. Along with the foremost heritage Indo-Islamic
            ...
            <div className="figure hover-blur">
              ...
              <figcaption className="fig-caption no-bg text-white text-center">
                ...
                <p>
                  ...
                  festivals, and the dramatic terrain are just some of the many
                  things this state is famous for. Whether you are looking for
                  an adventure to give you an adrenaline high or a tranquil spot
                  to recharge yourself, Meghalaya has plenty to offer.
                </p>
              </figcaption>
            </div>
          </a>
