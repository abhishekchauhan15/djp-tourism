                ...
                <div className="flip-card-inner">
                  <div className="flip-card-front figure">
                    ...
                    <figcaption className="fig-caption text-white">
                      ...
                      <p>Experience the natural beauty</p>
                    </figcaption>
                  </div>
                  <div className="flip-card-back figure">
                    <img
              ...
              <a href="/wild">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back figure">
                    ...
                    <figcaption className="fig-caption h-100 no-bg text-white text-shadow-on-blur">
                      <p>
                        Conservation reserves, world heritage sites and national
                        parks teeming with varied flora and fauna - Uttarakhand
                        has it all.
                      </p>
                    </figcaption>
                  </div>
              ...
              <a href="/flavours-land">
                <div className="flip-card-inner">
                  <div className="flip-card-front figure">
                    ...
                    <figcaption className="fig-caption text-white">
                      <h3>Flavours of the land</h3>
                      <p>Relish traditional food</p>
                    </figcaption>
                  </div>
                  <div className="flip-card-back figure">
                    <img
              ...
              <a href="/voices-and-culture">
                <div className="flip-card-inner">
                  <div className="flip-card-front figure">
                    ...
                    <figcaption className="fig-caption text-white">
                      <h3>Voices and Culture</h3>
                      <p>Local festivals and events</p>
                    </figcaption>
                  </div>
                  <div className="flip-card-back figure">
                    <img
